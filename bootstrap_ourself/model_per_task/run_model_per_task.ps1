...
$requirementsPath = "bootstrap_ourself\model_per_task\model_per_task_requirements.md"
$outputPath = "bootstrap_ourself\model_per_task\test_output.yaml"
...
$expectedOutputFileName = "model_per_task_requirements_bootstrap_config.yaml" 
