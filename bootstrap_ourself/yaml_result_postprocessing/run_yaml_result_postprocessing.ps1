...
$requirementsPath = "bootstrap_ourself\yaml_result_postprocessing\yaml_result_postprocessing_requirements.md"
$outputPath = "bootstrap_ourself\yaml_result_postprocessing\test_output.yaml"
...
$expectedOutputFileName = "yaml_result_postprocessing_requirements_bootstrap_config.yaml" 
