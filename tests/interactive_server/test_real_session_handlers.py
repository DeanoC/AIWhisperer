def test_error_event_notification(interactive_app):
    ...
    with client.websocket_connect("/ws") as websocket:
        ...
        for _ in range(3):
            notif = json.loads(watchdog_recv(websocket))
    ...
    def test_body():
        try:
            ...
            with client.websocket_connect("/ws") as websocket:
                ...
                stop_resp = json.loads(watchdog_recv(websocket))
                ...
                stop_resp2 = json.loads(watchdog_recv(websocket))
                ...
                stop_resp3 = json.loads(watchdog_recv(websocket))
    ...
    def test_body():
        try:
            ...
            with client.websocket_connect("/ws") as websocket:
                ...
                resp = json.loads(watchdog_recv(websocket))
