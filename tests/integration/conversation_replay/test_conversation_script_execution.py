"""
Integration tests for conversation script execution with ScriptParserTool and ConversationCommandTool.
...
class TestConversationScriptIntegration:
    """Integration tests for conversation script execution"""
