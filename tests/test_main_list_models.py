...
class TestMainListModels:
    ...
    def test_main_list_models_success_rewritten(
        self, mock_requests_get, mock_load_config, mock_api_cls, mock_setup_logging, mock_setup_rich, mock_sys_exit
    ):
        ...
        mock_load_config.return_value = {
            "openrouter": dummy_openrouter_config
        }  # Mock load_config to return a dictionary
        ...
        mock_api_cls.assert_called_once_with(
            dummy_openrouter_config
        )  # Check OpenRouterAPI was instantiated with the correct config part
