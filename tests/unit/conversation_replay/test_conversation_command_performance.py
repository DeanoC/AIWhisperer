"""
Performance tests for ConversationCommandTool.
Ensures conversation execution doesn't introduce significant overhead.
"""
...
class TestConversationCommandPerformance:
    """Performance tests for conversation command execution"""
    ...
    def command_tool(self):
        """Create ConversationCommandTool instance"""
