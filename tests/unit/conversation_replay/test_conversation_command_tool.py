"""
Unit tests for ConversationCommandTool.
...
from ai_whisperer.tools.conversation_command_tool import ConversationCommandTool, CommandInterpreter
from ai_whisperer.tools.script_parser_tool import ParsedScript, ScriptFormat


class TestConversationCommandTool:
    """Test ConversationCommandTool functionality"""
    
    @pytest.fixture
    def command_tool(self):
        """Provide an initialized ConversationCommandTool"""
        return ConversationCommandTool()
    ...
    def sample_json_script(self):
        ...
        return ParsedScript(
            ...
            name="Test Script",
            description="A test conversation script",
            steps=[
    ...
    def test_conversation_command_tool_creation(self, command_tool):
        """Test that ConversationCommandTool can be created"""
        assert command_tool is not None
        assert hasattr(command_tool, 'name')
        assert command_tool.name == 'conversation_command'
        assert hasattr(command_tool, 'description')
    
    def test_conversation_command_tool_has_required_methods(self, command_tool):
        """Test that ConversationCommandTool has required methods"""
