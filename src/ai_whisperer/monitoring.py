...
class TerminalMonitor:
    ...
    def _create_layout(self) -> Layout:
        ...
        layout.split(Layout(name="header", size=3), Layout(name="main_content", ratio=1), Layout(name="footer", size=3))
        ...
        layout["footer"].split_row(Layout(name="status_bar_panel", ratio=3), Layout(name="user_input_panel", ratio=1))
        return layout
    ...
    def _get_plan_overview_panel_content(self) -> Panel:
        ...
        for step in plan_steps_data:
            subtask_id = step.get("subtask_id", "N/A")
            description = step.get("description", "No description")
            status = self.state_manager.get_task_status(subtask_id) or "Pending"
            ...
            table.add_row(subtask_id, description, Text(status.capitalize(), style=status_style))
